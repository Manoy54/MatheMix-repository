...
import { User, Users, Trophy, Zap, Target, LogOut, Sparkles, Brain, Calculator, Star, Award, Crown, Menu } from 'lucide-react';
import { motion } from 'framer-motion';
import Background3D from '../components/Background3D.jsx';

export default function ModeSelect({ username, onLogout, onOpenSidebar }) {
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        {achievements.map((achievement, index) => (
                                            <div key={index} className={`flex items-center gap-3 p-2 rounded-lg border transition-colors ${
                                                achievement.earned
